<template>
    ...
    v-bind:id="sId" v-bind:style="'top:'+sTop.toString()+'%;left:'+sLeft.toString()+'%;width:'+(sRight-sLeft).toString()+'%;height:'+(sBottom-sTop).toString()+'%;'">
...
.blur-back::before {
    ...
    width: 100%;
    height: 100%;
    background-image: v-bind("'url('+sImageSrc+')'");
